...
ARCH_NAMES = [name for name in dir(archs) if not name.startswith("_")]
...
def main():
    ...
    if dataset_name == 'busi':
        ...
        mask_ext = '.png'
    # img_ext = '.jpg'  # Change to '.jpg' based on your dataset's image file extension
    ...
    for epoch in range(config['epochs']):
        ...
        # train for one epoch
        train_log = train(config, train_loader, model.to(device), criterion, optimizer)
